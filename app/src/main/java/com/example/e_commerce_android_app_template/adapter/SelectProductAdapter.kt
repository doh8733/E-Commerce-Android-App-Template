...
class SelectProductAdapter(
...
) : RecyclerView.Adapter<SelectProductAdapter.ProductsViewholder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductsViewholder {
        val adapter = LayoutInflater.from(parent.context).inflate(R.layout.gird_layout_product, parent, false)
